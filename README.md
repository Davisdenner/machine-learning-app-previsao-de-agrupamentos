<h1> app-previsao-de-agrupamentos
</h1>

<h2>💬Sobre</h2>
<p>M Modelo de machine learning capaz de agrupar clientes com base em seus interesses. O modelo conta com uma aplicação web para visualização e análise dos dados.</p>
